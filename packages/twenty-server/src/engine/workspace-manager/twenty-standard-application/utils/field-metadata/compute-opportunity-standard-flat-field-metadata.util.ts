...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  stage: createStandardFieldFlatMetadata({
    ...
    workspaceId,
    context: {
      // FORK: Voka CRM — Kommo Kanban stages (colors are DATA, read by RecordBoardColumnHeader faixa)
      fieldName: 'stage',
      type: FieldMetadataType.SELECT,
      label: i18nLabel(msg`Etapa`),
      description: i18nLabel(msg`Etapa do lead no funil`),
      icon: 'IconProgressCheck',
      isNullable: false,
      defaultValue: "'LEADS_RECEBIDOS'",
      options: [
        {
          id: '20202020-8e01-4afd-9c39-d2063097587a',
          value: 'LEADS_RECEBIDOS',
          label: i18nLabel(msg`Leads Recebidos`),
          position: 0,
          color: 'yellow',
        },
        {
          ...
          label: i18nLabel(msg`Tomada de Decisão`),
          position: 1,
          color: 'purple',
        },
        {
          ...
          value: 'NEGOCIACAO',
          label: i18nLabel(msg`Negociação`),
          position: 2,
          color: 'green',
        },
        {
          ...
          value: 'DECISAO_FINAL',
          label: i18nLabel(msg`Decisão Final`),
          position: 3,
          color: 'blue',
        },
        {
