  ...
  opportunity: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        // FORK: Voka CRM — renamed Opportunity → Lead (Kommo glossary)
        labelSingular: i18nLabel(msg`Lead`),
        labelPlural: i18nLabel(msg`Leads`),
        description: i18nLabel(msg`Um lead no funil de vendas`),
